...
public class ConsultarInfraccionesActivity extends Activity implements
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		if (!mNavigationDrawerFragment.isDrawerOpen()) {
			...
			getMenuInflater().inflate(R.menu.consultar_infracciones, menu);
			restoreActionBar();
			return true;
		}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(
					R.layout.fragment_consultar_infracciones, container, false);
			return rootView;
		}
		...
		public void onAttach(Activity activity) {
			...
			((ConsultarInfraccionesActivity) activity)
